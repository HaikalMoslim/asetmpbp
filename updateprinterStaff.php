...
if(isset($_POST['submit'])){
   ...
   $sql="update `printer` set id_printer=$id_printer,nama_printer='$nama_printer',jabatan='$jabatan',model_printer='$model_printer',tahun_printer='$tahun_printer',no_aset_printer='$no_aset_printer',notes='$notes' where id_printer=$id_printer";
   $result=mysqli_query($connect,$sql);
   if($result){
...
<form method="post">
  ...
  <div class="inputfield">
    ...
    <input type="text" class="input" placeholder="Isi nama printer" name="nama_printer" autocomplete="off" required value=<?php echo $nama_printer ?>>
  </div>
 <div class="inputfield">
    <label>Jabatan:</label>
 ...
 <div class="inputfield">
  ...
  <div class="inputfield">
   ...
   <select name="tahun_printer" class="custom_select" required value="<?php echo isset($tahun_printer) ? $tahun_printer : '' ?>">
