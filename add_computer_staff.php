...
if(isset($_POST['submit'])){
   ...
   $sql="insert into `computer` (no_aset_comp,nama_user,nama,jabatan,jenama_comp,model_comp,jenis_comp,ram,os,processor,ip_address,workgroup,tahun_comp,notes) values('$no_aset_comp','$nama_user','$nama','$jabatan','$jenama_comp','$model_comp','$jenis_comp','$ram','$os','$processor','$ip_address','$workgroup','$tahun_comp','$nota')";
...
<form method="post">
 ...
 <div class="inputfield">
    <label>Jenis</label>
          ...
          <select name="jenis_comp" class="custom_select"  value="<?php echo isset($jenis_comp) ? $jenis_comp : '' ?>">
...
<div class="inputfield">
    ...
    <input type="text" class="input" placeholder="Isi processor" name="processor" autocomplete="off">
  </div>
  <div class="inputfield">
 ...
 <div class="inputfield">
    ...
    <select name="workgroup" class="custom_select"  value="<?php echo isset($workgroup) ? $workgroup : '' ?>">
