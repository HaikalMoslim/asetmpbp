  ...
  <body>
   ...
   ?>
    <div class="card-box mb-30">
      <div class="pd-20">
        <div align="right">
          <a href="add_computer_staff.php" class="display_btn">Tambah Peranti</a>
        </div>
      </div>
      <div class="pb-20">
    ...
    while($row=mysqli_fetch_assoc($result)){
      ...
      <div class='dropdown'>
                    ...
                    <div class='dropdown-menu dropdown-menu-right dropdown-menu-icon-list'>
                        <a class='dropdown-item' href='updatecompStaff.php?updateid=".$id."'><i class='dw dw-edit2'></i> Edit</a>
                    </div>
                    </div>
