...
if(isset($_POST['submit1'])){
   ...
   $sql="insert into `printer` (nama_printer,jabatan_printer,model_printer,tahun_printer,no_aset_printer,nota) values('$nama_printer','$jabatan_printer','$model_printer','$tahun_printer','$no_aset_printer','$nota')";
...
<form method="post">
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Isi no aset printer" name="no_aset_printer" autocomplete="off">
  </div>
  <div class="form-group">
    <label>Nama Printer:</label>
    <input type="text" class="form-control" placeholder="Isi nama printer" name="nama_printer" autocomplete="off">
  </div>
  <div class="form-group">
      <label>Jabatan:</label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Isi model printer" name="model_printer" autocomplete="off">
  </div>
  <div class="form-group">
