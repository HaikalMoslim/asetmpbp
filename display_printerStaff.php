    ...
    while($row=mysqli_fetch_assoc($result)){
      ...
      <div class='dropdown'>
                    ...
                    <div class='dropdown-menu dropdown-menu-right dropdown-menu-icon-list'>
                        <a class='dropdown-item' href='updateprinterStaff.php?updateid=".$id_printer."'><i class='dw dw-edit2'></i> Edit</a>
                    </div>
                    </div>
