...
if(isset($_POST['submit'])){
   ...
   $sql="update `computer` set id_comp=$id,no_aset_comp='$no_aset_comp',nama='$nama',jabatan='$jabatan',jenama_comp='$jenama_comp',model_comp='$model_comp',nama_user='$nama_user',jenis_comp='$jenis_comp',ram='$ram',os='$os',processor='$processor',ip_address='$ip_address',workgroup='$workgroup',tahun_comp='$tahun_comp',notes='$notes' where id_comp=$id";
   $result=mysqli_query($connect,$sql);
   if($result){
